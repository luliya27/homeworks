    ...
    [
            ...
            _.extend(Cart.prototype, Backbone.Events, {
                ...
                addTo: function (to, model) {
                    ...
                    if (!m) {
                        ...
                        if (l.multiple) {
                            m.set({
                                quantity: m.attributes.quantity + 1
                            });
                            m.save();
                        }
                    }
        ...
        function (module, exports, __webpack_require__) {
            ...
            var Controller = function () {
                ...
                webfont.load({
                    google: {
                        families: Options.vars.googlefonts
                    },
                    classes: false,
                    events: false
                });
                ...
                this.iswish && this.wishlist.fetch({
                    reset: true
                });
            };
            ...
            _.extend(Controller.prototype, {
                ...
                onStartup: function (e) {
                    ...
                    if (this.cartlistReceived && (this.wishlistReceived || !this.wishlist)) {
                        if (this.cartlist.models.length > 0 || this.wishlist && this.wishlist.models
                            .length > 0) {
        ...
        function (module, exports, __webpack_require__) {
            ...
            _.extend(Animator.prototype, Backbone.Events, {
                ...
                activate: function () {
                    ...
                    TweenMax.to(this.$button, this.animation.button.DurationIN, _.extend({}, this
                        .animation.button.TransitionIN, {
                ...
                deactivate: function (reason) {
                    ...
                    TweenMax.to(this.$button, this.animation.button.DurationOUT, this.animation
                        .button.TransitionOUT);
                    TweenMax.to(this.$tint, this.animation.tint.DurationOUT, this.animation.tint
                        .TransitionOUT);
                    TweenMax.to(this.$panel, this.animation.panel.DurationOUT, this.animation.panel
                        .TransitionOUT);
                },
                ...
                show: function () {
                    ...
                    TweenMax.to(this.$button, this.animation.button.DurationOUT, this.animation
                        .button.TransitionOUT);
                    TweenMax.to(this.$tint, this.animation.tint.DurationIN, this.animation.tint
                        .TransitionIN);
                    TweenMax.to(this.$panel, this.animation.panel.DurationIN, _.extend({}, this
                        .animation.panel.TransitionIN, {
        ...
        function (module, exports, __webpack_require__) {
            ...
            var PanelView = Backbone.View.extend({
                ...
                initialize: function () {
                    ...
                    this.cartSection = new SectionView({
                        el: '.cp-section-cart',
                        list: this.cartList,
                        panel: this
                    });
                    this.wishSection = this.iswish ? new SectionView({
                        el: '.cp-section-wish',
                        list: this.wishList,
                        panel: this
                    }) : null;
                ...
                change: function (section) {
                    ...
                    this.$checkoutButton.toggleClass('hidden', cartListStats.totalItems == 0 || this
                    ...
                    this.iswish && $('.wish-tab').toggleClass('gs-tab-selected', this.section ==
                        'wish');


                    this.section == 'cart' ? this.cartSection.activate() : this.cartSection
                        .deactivate();
                    this.iswish ? this.section == 'wish' ? this.wishSection.activate() : this
                        .wishSection.deactivate() : null;
            ...
            _.extend(PanelView.prototype, {
                ...
                activateRendering: function (section) {
                    ...
                    this.iswish && this.listenTo(this.wishList, 'destroy change add reset', this
                        .render);
                    this.render();
                },
                ...
                render: function () {
                    ...
                    this.$headerTotalCostLabel.html(Utils.format(cartListStats.totalCost, this
                        .currency));
                    this.$headerTotalWishLabel && this.$headerTotalWishLabel.html(wishListStats ?
        ...
        function (module, exports) {
            ...
            module.exports = {
                ...
                format: function (price, currency) {
                    ...
                    return p.before + '' + number.toFixed(Math.max(0, ~~p.n)).replace(new RegExp(r,
                        'g'), '$&' + p.divider) + '' + p.after;
                }
        ...
        function (module, exports, __webpack_require__) {
            ...
            var SectionView = Backbone.View.extend({
                    ...
                    this.scroller.on('flick', _.bind(function (e) {
                        if (Math.abs(this.scroller.distX) > 60) {
                            if (this.scroller.distX > 0) {
                                // right direction 
                                this.el.className == 'cp-section-cart' && this.panel
                                    .hidePanel();
                                this.iswish && this.el.className == 'cp-section-wish' &&
                                    this.panel.selectCartSection();
                            } else {
                                // left direction
                                this.iswish && this.el.className == 'cp-section-cart' &&
                                    this.panel.selectWishSection();
                            }
                        }
                    }, this));
                ...
                activate: function () {
                    ...
                    setTimeout(_.bind(function () {
                        var someClassName = '.' + this.el.className +
                            ' .cp-item-wrapper';
                        TweenMax.staggerTo(someClassName, 0.3, {
                            className: '+=active',
                            ease: Power4.easeIn
                        }, 0.025);
                ...
                insertItem: function (item) {
                    var o = {
                        ...
                        view = this.el.className == 'cp-section-cart' ? new CartSectionItem(o) :
                        new WishSectionItem(o);
                ...
                setEmpty: function () {
                    ...
                    if (this.list.getStats().totalItems < 1) {
                        $('.' + this.el.className + ' .cp-section-wrapper').append(EmptyHTML({
                            message: "Your " + (this.el.className == 'cp-section-cart' ?
                                "shopping cart" : "wish list") + " is empty."
                        }));

                    }

                    setTimeout(_.bind(function () {
                        $('.' + this.el.className + ' .cp-empty-section').addClass(
                            'active');
        ...
        function (module, exports, __webpack_require__) {
            ...
            _.extend(ButtonView.prototype, {
                ...
                activateRendering: function () {
                    ...
                    this.iswish && this.listenTo(this.wishList, 'reset add destroy change', this
                        .render);
            ...
            module.exports = function (obj) {
                ...
                with(obj) {
                    ...
                    if (totalCart > 0 || totalWish > 0) {
                        ...
                        print(totalWish > 0 && totalCart > 0 ? ' cb-state_both' : totalCart > 0 ?
                            ' cb-state_cart' : ' cb-state_wish');
                        __p +=
        ...
        function (module, exports, __webpack_require__) {
            ...
            if (false) {
                ...
                if (!content.locals) {
                    module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./style.css",
                    function () {
        ...
        function (module, exports, __webpack_require__) {
            ...
            module.exports = function (list, options) {
                if (false) {
                    if (typeof document !== "object") throw new Error(
            ...
            function insertStyleElement(options, styleElement) {
                ...
                var lastStyleElementInsertedAtTop = styleElementsInsertedAtTop[styleElementsInsertedAtTop
                    .length - 1];
            ...
            function addStyle(obj, options) {
                ...
                return function updateStyle(newObj) {
                    if (newObj) {
                        if (newObj.css === obj.css && newObj.media === obj.media && newObj.sourceMap === obj
                            .sourceMap)
                            return;
                        update(obj = newObj);
                    } else {
